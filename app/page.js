      ...
      <div className="max-w-5xl mx-auto px-4 py-6 md:px-8 md:py-10">
        ...
        <div className="text-center mt-8 md:mt-10 space-y-3">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-rose-100 to-sky-100 hover:from-rose-200 hover:to-sky-200 text-slate-700 px-5 py-2.5 text-sm font-medium shadow-lg border border-white/60 transition-all hover:scale-105"
          >
